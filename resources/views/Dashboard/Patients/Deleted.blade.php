    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ trans('patient_translation.Delete_Patient_Data') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('Patients.destroy', 'test') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger"> {{ trans('patient_translation.Are_you_sure_about_Delete_Patient') }} </p>
