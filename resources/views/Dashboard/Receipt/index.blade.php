                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Receipt.create')}}" class="btn btn-primary" role="button"
                                           aria-pressed="true">{{ trans('receipt_trans.Add_New_Receipt') }}</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{ trans('receipt_trans.Patient_name') }}</th>
                                                <th>{{ trans('receipt_trans.The_Amount') }}</th>
                                                <th>{{ trans('receipt_trans.Statement') }}</th>
                                                <th>{{ trans('receipt_trans.Date_Added') }}</th>
                                                <th>{{ trans('receipt_trans.Operations') }}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
