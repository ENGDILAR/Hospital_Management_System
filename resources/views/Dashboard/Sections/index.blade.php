...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/sections_trans.pages')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{trans('Dashboard/sections_trans.empty')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                           ...
                                           @foreach($sections as $section)
                                               <tr>
                                                   ...
                                                   <td><a href="{{route('sections.show',$section->id)}}">{{$section->name}}</a> </td>
                                                        <!-- we use str limit to organize the description text limit to 50 char-->
                                                   <td>{{ \Str::limit($section->description, 50) }}</td>

                                                   <!-- to convert the time from  a normal date to a time created -->
