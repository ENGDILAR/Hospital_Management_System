                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    @foreach($patient_rays as $patient_ray)
                                                        <tr>
                                                            ...
                                                            @if($patient_ray->doctor_id == $SignedDoctorID->id)
                                                                @if($patient_ray->case == 0)
                                                                <td>
                                                                ...
                                                                @else
                                                                    <td>
                                                                        <a class="modal-effect btn btn-sm btn-warning"  href="{{route('doctor_invoices.show',$patient_ray->id)}}"><i class="fas fa-binoculars"></i></a>
                                                                    </td>
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                   ...
                                                   @foreach($patient_Laboratories as $patient_Laboratorie)
                                                        <tr>
                                                            ...
                                                            @if($patient_Laboratorie->doctor_id == $SignedDoctorID->id)
