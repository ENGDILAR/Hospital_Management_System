...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{ trans('Dashboard/main-sidebar_trans.charts') }}</span><i class="angle fe fe-chevron-down"></i></a>
					<!-- ################ Sections section #######################################-->
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('sections.index')}}">{{ trans('Dashboard/main-sidebar_trans.view') }}</a></li>
						</ul>
					</li>
					<!--################# Doctors section #########################################-->
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('Doctors.index')}}">{{trans('Dashboard/main-sidebar_trans.viewall')}}</a></li>
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('Patients.create')}}"> {{trans('Dashboard/main-sidebar_trans.ADD_patient')}}</a></li>
                <li><a class="slide-item" href="{{ route('Patients.index') }}"> {{trans('Dashboard/main-sidebar_trans.patient_list')}}</a></li>
		...
		<!-- ################## Ray section ######################################-->
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('ray_employee.index')}}">List Employees</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='form-advanced') }}">List Rays</a></li>
						</ul>
					</li>
	<!-- ################## Lab section ######################################-->
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h15v3H5zm12 5h3v9h-3zm-7 0h5v9h-5zm-5 0h3v9H5z" opacity=".3"/><path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM8 19H5v-9h3v9zm7 0h-5v-9h5v9zm5 0h-3v-9h3v9zm0-11H5V5h15v3z"/></svg><span class="side-menu__label">Laboratorie</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('laboratorie_employee.index')}}">Lab Employees</a></li>
