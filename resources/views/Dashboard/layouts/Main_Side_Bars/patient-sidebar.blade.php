	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{route('PatientDash.invoices')}}">قائمة الفواتير</a></li>
					<li><a class="slide-item" href="{{route('PatientDash.Laboratories')}}">المختبر</a></li>
					<li><a class="slide-item" href="{{route('PatientDash.rays')}}">الاشعة</a></li>
				</ul>
			</li>
		</ul>
	</div>
