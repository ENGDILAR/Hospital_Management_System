        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('Ambulance.update','test')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" name="car_type">
                                <option value="1" {{$ambulance->car_type == 1 ? 'selected':''}}>{{ trans('ambulance_trans.owned') }}</option>
                                <option value="2" {{$ambulance->car_type == 2 ? 'selected':''}}>{{ trans('ambulance_trans.rent') }}</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label> {{ trans('ambulance_trans.Status') }}</label>
                            &nbsp;
